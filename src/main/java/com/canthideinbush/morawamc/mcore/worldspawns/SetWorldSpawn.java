...
public class SetWorldSpawn extends InternalCommand {
    ...
    public boolean execute(Player sender, String[] args) {
        ...
        MCore.instance().worldSpawnsStorage().set(world.getName(), sender.getLocation());

        sendConfigSuccessMessage(sender, "commands.set-world-spawn.success");
        return true;
    }
